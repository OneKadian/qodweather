...
import Seven from "../components/widgets/Seven";
      ...
      <main className="container mx-auto">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="mt-4 md:mt-0 md:w-2/3">
            <div className="flex justify-items-center gap-4 overflow-hidden px-6 md:max-h-[33rem] md:grid-cols-4 md:hover:overflow-y-auto lg:grid-cols-5 lg:overflow-visible lg:hover:overflow-visible">
